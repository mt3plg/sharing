...
async function bootstrap() {
    ...
    const io = new Server(httpServer, {
        cors: {
            origin: '*', // Змініть на фронтенд-URL у продакшені, наприклад, 'https://your-frontend.com'
            methods: ['GET', 'POST'],
        },
        pingTimeout: 60000, // Час очікування пінгу (60 секунд)
        pingInterval: 25000, // Інтервал пінгу (25 секунд)
    });
